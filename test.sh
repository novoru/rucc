...
# assert 8 'int main() { int foo123=3; int foo345=5; return foo123+foo345; }'
...
# assert 2 'int main() { if (0) { ; } else { if (1) { return 2; } else { return 3; } } }'
...
assert 42 'int foo; int main() { int foo = 1; int foo = 42; return a; }'
